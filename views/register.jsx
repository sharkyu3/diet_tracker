            ...
            <div className="container-fluid">
                <div className="row-fluid">
                    <div className="col-6 offset-3">
                        <img className="img-fluid" src= "/pics/guildsapple.png" id="reglogo"></img>
                    </div>
                </div>
                <div className="row-fluid">
                    <div className="col-xs-6 offset-xs-3 col-lg-6 offset-lg-3" id="toprow">
                        <h2>Create GUIL:DS account</h2>
                    </div>
                </div>
                <div className="row-fluid">
                    <div className="col-xs-4 offset-xs-4 col-lg-4 offset-lg-4">
